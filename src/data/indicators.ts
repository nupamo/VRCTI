...
export const indicatorDescriptions: Record<string, IndicatorInfo> = {
  'S': { name: 'Sync', description: '현실의 자아를 아바타에 투영하여 진솔하게 소통합니다.' },
  'C': { name: 'Concept', description: '캐릭터의 설정과 페르소나를 유지하며 가상 세계의 삶을 즐깁니다.' },
  ...
  'P': { name: 'Private', description: '지인 위주의 프라이빗한 공간에서 안정적인 유대를 쌓는 것을 선호합니다.' },
  'F': { name: 'Friendly', description: '사람들과의 정서적 교류와 친목 형성을 주목적으로 활동합니다.' },
  'T': { name: 'Technical', description: '유니티, SDK, 월드 제작 등 가상 세계를 구축하는 기술적 활동에 집중합니다.' },
