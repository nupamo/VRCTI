...
export const questions: Question[] = [
  ...
  { indicator: 'P', text: "서로의 현실 정보를 나누는게 불편하다." },
  { indicator: 'S', text: "현실의 지인이 내 VRChat 플레이를 봐도 부끄럽지 않다." },
  { indicator: 'P', text: "아바타를 바꿀 때마다 그 아바타의 외형에 맞춰 말투나 행동을 조금씩 바꾼다." },
  ...
  // F (Friendly) vs C (Creator)
  { indicator: 'C', text: "나는 유니티나 블렌더 작업을 하다가 VRChat 접속을 포기할 때가 있다." },
  { indicator: 'C', text: "새로운 사람을 만나면 먼저 무슨 아바타나 에셋을 썼는지 궁금하다." },
  ...
  { indicator: 'C', text: "인게임에서 아바타 오류를 발견하면 VR을 쓰고 있어도 유니티를 킨다." }
